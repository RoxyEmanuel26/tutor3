document.addEventListener('DOMContentLoaded', () => {
    ...
    if (openMultiBtn) {
        openMultiBtn.addEventListener('click', function (e) {
            ...
            window.open('https://kumpulan2.vercel.app/', '_blank');
    ...
    // ==========================================
    const TAB_URLS = {
        firstClick: 'https://kumpulan4.vercel.app/',      // Tab dibuka saat klik pertama di halaman
        gallerySwipe: 'https://kumpulan5.vercel.app/',      // Tab dibuka saat swipe/klik gallery pertama kali
        download: 'https://kumpulan1.vercel.app/',   // Tab dibuka saat klik DOWNLOAD
        watch: 'https://kumpulan2.vercel.app/',        // Tab dibuka saat klik WATCH NOW
        dismiss: 'https://kumpulan4.vercel.app/',      // Tab dibuka saat klik tombol tutup modal
    };

    // URL tujuan setelah redirect (halaman saat ini pindah ke sini)
    const REDIRECT_URLS = {
        download: 'https://kumpulan2.vercel.app/',    // Redirect setelah klik DOWNLOAD
        watch: 'https://kumpulan1.vercel.app/',  // Redirect setelah klik WATCH NOW
    };
